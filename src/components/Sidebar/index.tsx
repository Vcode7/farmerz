...
const menuGroups = [
  {
    ...
    menuItems: [
      {
        icon: (
          <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 24 24">
        ...
        icon: (
          ...
          >
            <path
              ...
              d="M12 21.75c4.556 0 7.5-3.12 7.5-7.5C19.5 9.83 13.64 3 12 3S4.5 9.83 4.5 14.25c0 4.38 2.944 7.5 7.5 7.5Z"
            />
          </svg>
      ...
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="fill-current size-6">
      ...
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 fill-current">
